...
function setupPuzzle() {
   /*Match all of the data cells within the puzzle*/
   puzzleCells = document.querySelectorAll("table#hanjieGrid td");
   
   //set the intitial dcolor of each cell to gold
   for (var i = 0; i < puzzleCells.length; i++){
      puzzleCells[i].style.backgroundColor = "rgb(233,207,29)";
   // set the cell background color in resoponse to the mousedown event
...
function setBackground(e) {
   ...
   //Set the background based on the keyborad key
   if (e.shiftKey){
   ...
   //Creat an event listener for every puzzle cell
for (var i = 0; i < puzzleCells.length; i++){
